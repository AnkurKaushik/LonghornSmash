      ...
      <div>
            ...
            <Container style= {{marginBottom: "1em"}}>
              <Row>
                <Col>
                  ...
                  <h1 class="ls-title home-title text-center">Longhorn <span class="quirky-orange">Smash</span></h1>
                  <h2 class="ls-subheading home-subheading text-left">What is Longhorn Smash<span class="quirky-orange">?</span></h2>
                  <p class="ls-text home-text text-left">Longhorn Smash is a student-run club at UT Austin that focuses on playing competitve Smash Ultimate. As a club, we organize tournaments where
                  ...
                  <h2 class="ls-subheading home-subheading text-left">How can I sign up<span class="quirky-orange">?</span></h2>
                  <p class="ls-text home-text text-left">There's no "sign-up" form or application you need to submit! You can simply introduce yourself <a href="https://discord.gg/Ms6XvTga">in our discord</a> and start talking to other students there!
                    We promise we won't bite :-).
                  </p>
                  <h2 class="ls-subheading home-subheading text-left">Some more important information<span class="quirky-orange">.</span></h2>
                  <p class="ls-text home-text text-left">
        ...
        <div id="third">
          ...
          <Container>
            <Row>
              <Col>
                <h3 class="ls-title home-title text-center">Check out some <span class="quirky-orange">highlights!</span></h3>
                <div id="videoplayer">
